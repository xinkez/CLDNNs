...
class CreateDataList:
    ...
    def createDataList(self, data_root_path):
        ...
        for class_dir in class_dirs:
            ...
            trainer_sum = 0
            # 把生产的数据列表都放在自己的总类别文件夹中
            data_list_path = "/Users/Roy/PycharmProjects/CLDNN/%s/" % father_path
            # 统计每个类别有多少张图片
            class_sum = 0
            # 获取类别路径
            path = data_root_path + "/" + class_dir + "/new500"
            # 获取所有图片
...
if __name__ == '__main__':
    ...
    createDataList.createDataList('/Users/Roy/PycharmProjects/CLDNN/audio')